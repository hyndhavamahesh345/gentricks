...
const tracks: OpportunityTrack[] = [
  ...
  { num: '02', title: 'Competitions', desc: 'Challenges where original ideas become functional working prototypes.' },
  { num: '03', title: 'Projects', desc: 'Collaborative squads engineering open-source and proprietary systems.' },
  { num: '04', title: 'Startup Programs', desc: 'Structured venture incubation for youth-led technical innovations.' },
  { num: '05', title: 'Hackathons', desc: 'Fast-paced weekend sprints to experiment, build, and deploy software.' },
  { num: '06', creator: true, title: 'Creator Opportunities', desc: 'Residencies for UI/UX designers, 3D artists, and digital storytellers.' } as any,
];
    ...
    >
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            {tracks.map((t, idx) => {
              ...
              return (
                <div
                  ...
                  className={`rv rv-delay-${Math.min(idx + 1, 5)} py-4 flex items-center justify-between cursor-pointer transition-all duration-200 group ${
          ...
          {/* Right: Clean Balanced Portrait/Landscape Visual */}
          <div className="lg:col-span-5 rv-scale flex justify-center">
