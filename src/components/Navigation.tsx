    ...
    <>
      <header
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
          ...
          isScrolled
            ? 'h-[64px] bg-black/90 backdrop-blur-xl border-b border-white/[0.08]'
            : 'h-[72px] bg-transparent border-b border-white/[0.05]'
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 sm:px-8 h-full flex items-center justify-between">
          {/* Brand Logo */}
          <a href="#hero" className="flex items-center gap-3" aria-label="Gentricks">
            <img
              src="/assets/logo.svg"
              alt="Gentricks"
              className="h-7 sm:h-8 w-auto transition-opacity hover:opacity-85"
            />
          </a>
